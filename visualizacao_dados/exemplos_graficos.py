...
df = pd.read_csv('visualizacao_dados/clientes_preparados_cod.csv')


df_corr = df[['salario', 'idade', 'numero_filhos', 'nivel_educacao_cod', 'area_atuacao_cod', 'estado_cod']].corr()
